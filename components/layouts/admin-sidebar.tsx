...
import { LayoutDashboard, Users, Calendar, DoorOpen, Package, Menu, X, LogOut } from "lucide-react"
...
const navigation = [
  ...
  { name: "Kelola Peminjaman", href: "/admin/bookings", icon: Calendar },
  { name: "Kelola Ruangan", href: "/admin/rooms", icon: DoorOpen },
  { name: "Kelola Barang", href: "/admin/equipment", icon: Package },
]
